...
"[project]/node_modules/@daveyplate/better-auth-tanstack/dist/index.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "AuthQueryContext": (()=>AuthQueryContext),
    "AuthQueryProvider": (()=>AuthQueryProvider),
    "createAuthHooks": (()=>createAuthHooks),
    "createAuthPrefetches": (()=>createAuthPrefetches),
    "defaultAuthQueryOptions": (()=>defaultAuthQueryOptions),
...
var AuthQueryContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(defaultAuthQueryOptions);
var AuthQueryProvider = ({ children, sessionQueryOptions, tokenQueryOptions, ...props })=>{
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(AuthQueryContext.Provider, {
        value: {
            sessionQueryOptions: {
                staleTime: 60 * 1e3,
                ...sessionQueryOptions
...
function useSession(authClient, options) {
    var _a, _b;
    const { sessionQueryOptions, sessionKey: queryKey, queryOptions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    const mergedOptions = {
        ...queryOptions,
        ...sessionQueryOptions,
        ...options
...
function useAuthQuery({ authClient, queryKey, queryFn, options }) {
    const { data: sessionData } = useSession(authClient);
    const { queryOptions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    const mergedOptions = {
        ...queryOptions,
        ...options
    };
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey,
        queryFn: sessionData ? ()=>queryFn({
                fetchOptions: {
                    throw: true
                }
            }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["skipToken"],
        ...mergedOptions
    });
}
// src/hooks/accounts/use-list-accounts.ts
function useListAccounts(authClient, options) {
    const { listAccountsKey: queryKey } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    return useAuthQuery({
        authClient,
        queryKey,
...
var useOnMutateError = ()=>{
    ...
    const { optimistic } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    const onMutateError = (error, queryKey, context)=>{
        var _a, _b;
        if (error) {
            console.error(error);
            (_b = (_a = queryClient.getQueryCache().config).onError) == null ? void 0 : _b.call(_a, error, {
                queryKey
            });
        }
...
function useAuthMutation({ queryKey, mutationFn, optimisticData, options }) {
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQueryClient"])();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    const { optimistic } = {
        ...context,
        ...options
    };
...
function useListDeviceSessions(authClient, options) {
    const { listDeviceSessionsKey: queryKey } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    return useAuthQuery({
        authClient,
        queryKey,
...
function useSetActiveSession(authClient, options) {
    ...
    const { onMutateError } = useOnMutateError();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    const { listDeviceSessionsKey: queryKey } = {
        ...context,
        ...options
    };
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: ({ fetchOptions = {
            throw: true
        }, ...params })=>authClient.multiSession.setActive({
                fetchOptions,
                ...params
            }),
...
function useDeletePasskey(authClient, options) {
    const { listPasskeysKey: queryKey } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    return useAuthMutation({
        queryKey,
...
function useUpdateUser(authClient, options) {
    const { sessionKey: queryKey } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    return useAuthMutation({
        queryKey,
...
function useListSessions(authClient, options) {
    const { listSessionsKey: queryKey } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    return useAuthQuery({
        authClient,
        queryKey,
...
function useToken(authClient, options) {
    ...
    const { tokenKey, tokenQueryOptions, queryOptions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AuthQueryContext);
    const mergedOptions = {
        ...queryOptions,
        ...tokenQueryOptions,
        ...options
    ...
    const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>data ? decodeJwt(data.token) : null, [
        data
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    const isTokenExpired = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
    ...
    const tokenData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>!sessionData || isTokenExpired() || (sessionData == null ? void 0 : sessionData.user.id) !== (payload == null ? void 0 : payload.sub) ? void 0 : data, [
        sessionData,
        isTokenExpired,
        payload,
        data
    ...
    return {
        ...rest,
        data: tokenData,
        token: tokenData == null ? void 0 : tokenData.token,
        payload
    };
}
...
function createAuthHooks(authClient) {
    return {
        ...
        useAuthQuery: ({ queryKey, queryFn, options })=>useAuthQuery({
                authClient,
                queryKey,
                queryFn,
                options
...
function createAuthPrefetches(authClient, queryOptions) {
    return {
        prefetchSession: (queryClient, options)=>{
            return prefetchSession(authClient, queryClient, {
                ...defaultAuthQueryOptions,
                ...queryOptions
            }, options);
        }
...
//# sourceMappingURL=node_modules_71890cd9._.js.map